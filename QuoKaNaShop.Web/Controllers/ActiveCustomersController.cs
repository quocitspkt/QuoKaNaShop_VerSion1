...
namespace QuoKaNaShop.Web.Controllers
{
    public class ActiveCustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Username,Password,ConfirmPassword,FullName,Address,Email,Photo,ID")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Username,Password,ConfirmPassword,FullName,Address,Email,Photo,ID")] Customer customer)
        {
            if (ModelState.IsValid)
            {
